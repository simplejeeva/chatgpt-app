...
SECRET_KEY = 'django-insecure-+gs-2c@$f)bja(%%ljmb+!3%ixca2!9wb-3h)*ecsq_ag5*@g^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'chatgpt-app-ny8i.onrender.com',  
    'localhost',
    '127.0.0.1',
]
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            'level': 'INFO',  # Change to 'DEBUG' if you want more detailed logs
